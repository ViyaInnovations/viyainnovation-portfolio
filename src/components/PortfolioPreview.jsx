  ...
  >
    ...
    <div className="p-5">
      ...
      <div className="mt-4 pt-3 border-t border-gray-100">
        <span
          className="inline-flex items-center gap-2 text-sm font-semibold group-hover:opacity-80"
          style={{ color: NAVY_BLUE }}
        >
          View Case Study
          <ArrowRight size={16} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-600 text-base md:text-lg">
            We believe in showing, not telling. Explore our featured case studies showcasing strategy, design, tech, and impact.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <motion.a
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.backgroundColor = NAVY_HOVER_BG)
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.backgroundColor = NAVY_BLUE)
            }
          >
            <Target size={20} />
            View All Projects
