...
export default function Services() {
    const services = [
...

        {
            ...
            description: "Creative visual designs that communicate your brand message effectively and beautifully",
...

        {
            ...
            description: "Dynamic animated graphics and visual effects that bring your content to life",
...

        {
            ...
            title: "Events",
            description: "End-to-end event management and execution that creates memorable experiences",
...

        {
            ...
            title: "Photography",
            description: "Professional photography services that capture stunning visuals for your brand",
...

        {
            ...
            title: "Branding",
            description: "Complete brand identity development that makes your business stand out in the market",
...

        {
            ...
            description: "Compelling video ads that tell your story and drive action across platforms",
...

        {
            ...
            title: "SEO",
            description: "Search engine optimization strategies that improve rankings and increase organic traffic",
...

        {
            ...
            title: "Campaigns",
            description: "Integrated marketing campaigns designed to achieve your business objectives",
            ...
            <div className="relative overflow-hidden rounded-xl h-48 mb-6">
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2">
                    {service.images.map((_, i) => (
                        <div key={i} className={`w-2 h-2 rounded-full ${i === current ? "bg-white" : "bg-white/50"}`}></div>
                    ))}
                </div>
            </div>
