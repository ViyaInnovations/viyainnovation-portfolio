        ...
        <div className="mt-16 overflow-hidden">
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <motion.article
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white p-8 rounded-2xl shadow-lg max-w-full"
              itemProp="mainEntity"
              itemScope
            ...
            >
              ...
              <a
                ...
                className="mt-6 inline-flex items-center justify-center gap-3 w-full max-w-full px-6 py-4 rounded-xl bg-green-500 text-white font-semibold text-lg hover:bg-green-600 transition"
            ...
            >
              <article
                className="bg-white p-6 rounded-xl shadow max-w-full"
                itemScope
              ...
              <article className="bg-white p-6 rounded-xl shadow max-w-full">
