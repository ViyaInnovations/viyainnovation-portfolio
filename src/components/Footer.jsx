        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
                    ...
                    <div className="sm:col-span-2 lg:col-span-4" itemScope itemType="https://schema.org/Organization">
                    ...
                    <address className="sm:col-span-1 lg:col-span-3 not-italic" itemScope itemType="https://schema.org/PostalAddress">
                        <motion.h4 
                            variants={footerVariants} 
                            className="font-semibold text-base sm:text-lg mb-3 sm:mb-4 uppercase tracking-wider" 
                            style={{ color: ACCENT_COLOR }}
                        ...
                        <ul className="space-y-3 sm:space-y-4 text-xs sm:text-sm">
                            <motion.li variants={footerVariants} className="flex items-start gap-2 sm:gap-3">
                                ...
                                <a href="mailto:info@viyainnovations.com" itemProp="email" className="text-gray-300 hover:text-white transition duration-150 break-all">
                                     info@viyainnovations.com
                                </a>
                            </motion.li>
                            <motion.li variants={footerVariants} className="flex items-start gap-2 sm:gap-3">
                                <Phone size={16} className="shrink-0 mt-0.5 sm:mt-1" style={{ color: ACCENT_COLOR }} />
                                <span itemProp="telephone" className="text-gray-300">+91 799 4149 009</span>
                            </motion.li>
                            <motion.li variants={footerVariants} className="flex items-start gap-2 sm:gap-3">
                                <MapPin size={16} className="shrink-0 mt-0.5 sm:mt-1" style={{ color: ACCENT_COLOR }} />
                                <span itemProp="streetAddress" className="text-gray-300 leading-relaxed">
                    ...
                    <div className="sm:col-span-2 lg:col-span-3">
                        ...
                        <motion.div variants={footerVariants} className="flex space-x-4 sm:space-x-5">
                            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-white transition duration-150">
                                <Linkedin size={22} className="sm:w-6 sm:h-6" />
                            </a>
                            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-400 hover:text-white transition duration-150">
                                <Twitter size={22} className="sm:w-6 sm:h-6" />
                            </a>
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-white transition duration-150">
